// ============================================
// Epargne IA — Landing Page Scripts
// ============================================
...
const translations = {
    en: {
        ...
        'hero.trust': 'Join <strong>15,000+</strong> traders already using Epargne IA',
        ...
        'test.t1_text': '"I tried manual trading for 2 years with no success. Since using Epargne IA, my results are incomparable. The AI detects opportunities I would never have seen."',
        ...
        'test.t3_text': '"As a developer, I was skeptical. But the technology behind Epargne IA is solid. The continuous learning produces increasingly precise results over time."',
        ...
        'footer.copyright': '© 2026 Epargne IA. All rights reserved.',
        ...
        'modal.desc': 'Welcome to Epargne IA. Check your email to activate your account and start trading with our AI agent.',
        'modal.btn': 'Got It',
    },
    fr: {
        // Nav
        ...
        'hero.trust': 'Rejoignez <strong>15 000+</strong> traders qui utilisent déjà Epargne IA',
        ...
        'test.t1_text': '« J\'ai essayé le trading manuel pendant 2 ans sans succès. Depuis que j\'utilise Epargne IA, mes résultats sont incomparables. L\'IA détecte des opportunités que je n\'aurais jamais vues. »',
        ...
        'test.t3_text': '« En tant que développeur, j\'étais sceptique. Mais la technologie derrière Epargne IA est solide. L\'apprentissage continu produit des résultats de plus en plus précis au fil du temps. »',
        ...
        'footer.copyright': '© 2026 Epargne IA. Tous droits réservés.',
        ...
        'modal.desc': 'Bienvenue sur Epargne IA. Vérifiez votre email pour activer votre compte et commencer à trader avec notre agent IA.',
        'modal.btn': 'Compris',
    }
};
...
function setLanguage(lang) {
    ...
    document.title = lang === 'fr' ? 'Epargne IA — Agent de Trading IA Autonome' : 'Epargne IA — Autonomous AI Trading Agent';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    signupForm.addEventListener('submit', async (e) => {
        ...
        // 2. Send to Telegram
        try {
            const msg = `🔔 *Nouveau Lead Epargne IA*\n\n` +
