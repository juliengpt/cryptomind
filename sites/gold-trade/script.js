// ============================================
// GoldTrade AI — Landing Page Scripts
// ============================================
...
const translations = {
    en: {
        ...
        'hero.trust': 'Join <strong>15,000+</strong> traders already using GoldTrade AI',
        ...
        'test.t1_text': '"I tried manual trading for 2 years with no success. Since using GoldTrade AI, my results are incomparable. The AI detects opportunities I would never have seen."',
        ...
        'test.t3_text': '"As a developer, I was skeptical. But the technology behind GoldTrade AI is solid. The continuous learning produces increasingly precise results over time."',
        ...
        'footer.copyright': '© 2026 GoldTrade AI. All rights reserved.',
        ...
        'modal.desc': 'Welcome to GoldTrade AI. Check your email to activate your account and start trading with our AI agent.',
        'modal.btn': 'Got It',
    },
    fr: {
        // Nav
        ...
        'hero.trust': 'Rejoignez <strong>15 000+</strong> traders qui utilisent déjà GoldTrade AI',
        ...
        'test.t1_text': '« J\'ai essayé le trading manuel pendant 2 ans sans succès. Depuis que j\'utilise GoldTrade AI, mes résultats sont incomparables. L\'IA détecte des opportunités que je n\'aurais jamais vues. »',
        ...
        'test.t3_text': '« En tant que développeur, j\'étais sceptique. Mais la technologie derrière GoldTrade AI est solide. L\'apprentissage continu produit des résultats de plus en plus précis au fil du temps. »',
        ...
        'footer.copyright': '© 2026 GoldTrade AI. Tous droits réservés.',
        ...
        'modal.desc': 'Bienvenue sur GoldTrade AI. Vérifiez votre email pour activer votre compte et commencer à trader avec notre agent IA.',
        'modal.btn': 'Compris',
    }
};
...
function setLanguage(lang) {
    ...
    document.title = lang === 'fr' ? 'GoldTrade AI — Agent de Trading IA Autonome' : 'GoldTrade AI — Autonomous AI Trading Agent';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    signupForm.addEventListener('submit', async (e) => {
        ...
        // 2. Send to Telegram
        try {
            const msg = `🔔 *Nouveau Lead GoldTrade AI*\n\n` +
